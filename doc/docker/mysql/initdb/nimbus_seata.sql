...
MySQL - 8.0.25 : Database - nimbus_seata
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS */`nimbus_seata` /*!40100 DEFAULT CHARACTER SET utf8 */ /*!80016 DEFAULT ENCRYPTION = 'N' */;
...
(
    ...
    `transaction_service_group` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci  DEFAULT NULL,
