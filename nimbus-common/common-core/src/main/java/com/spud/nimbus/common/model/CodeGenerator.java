// package com.spud.nimbus.common.model;
//
//
...
// 数据源配置
// */
// String schema = "nimbus_user";
// DataSourceConfig dsc = new DataSourceConfig.Builder("jdbc:mysql://localhost:3307/" +
// schema, "root", "157426.+")
...
// .entity("model")//实体类包名
// .parent("com.spud.nimbus")//父包名。如果为空，将下面子包名必须写全部， 否则就只需写子包名
// .moduleName(schema)//父包模块名
...
// .pathInfo(Collections.singletonMap(OutputFile.mapperXml, projectPath +
// "/table/resources/" + schema + "/mapper")) //路径配置信息,就是配置各个文件模板的路径信息,这里以mapper.xml为例
// .build();
// /*
// 模板配置
// */
