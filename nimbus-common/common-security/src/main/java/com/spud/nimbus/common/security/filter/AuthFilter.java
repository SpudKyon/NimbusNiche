...
public class AuthFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		// 校验token，并返回用户信息
		Result<UserInfoInTokenBO> userInfoInTokenVoResult = tokenFeignClient.checkToken(accessToken);
	...
	public boolean checkRbac(UserInfoInTokenBO userInfoInToken, String uri, String method) {
		...
		Result<Boolean> booleanResult = permissionFeignClient.checkPermission(userInfoInToken.getUserId(),
				userInfoInToken.getSysType(), uri, userInfoInToken.getIsAdmin(),
