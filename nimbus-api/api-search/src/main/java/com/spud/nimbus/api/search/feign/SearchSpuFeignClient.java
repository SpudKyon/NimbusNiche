...
public interface SearchSpuFeignClient {
	...
	Result<EsPageVO<ProductSearchVO>> search(@RequestParam("pageDTO") EsPageDTO pageDTO,
	...
	Result<EsPageVO<ProductSearchVO>> spuPage(@RequestParam("pageNum") Integer pageNum,
			@RequestParam("pageSize") Integer pageSize, @RequestParam("shopId") Long shopId);
	...
	Result<List<SpuSearchVO>> limitSizeListByShopIds(@RequestParam("shopIds") List<Long> shopIds,
