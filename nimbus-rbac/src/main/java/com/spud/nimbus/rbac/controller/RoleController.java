...
public class RoleController {
	...
	public Result<PageVO<RoleVO>> page(@Valid PageDTO pageDTO) {
		...
		PageVO<RoleVO> rolePage = roleService.page(pageDTO, userInfoInTokenBO.getSysType(),
	...
	public Result<Void> update(@Valid @RequestBody RoleDTO roleDTO) {
		...
		if (!Objects.equals(dbRole.getBizType(), userInfoInTokenBO.getSysType())
				|| !Objects.equals(dbRole.getTenantId(), userInfoInTokenBO.getTenantId())) {
