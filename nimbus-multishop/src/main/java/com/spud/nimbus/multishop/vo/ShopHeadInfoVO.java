 ...
 * @date 2024/2/24
 */
public class ShopHeadInfoVO extends BaseVO {
	...
	public String toString() {
		return "ShopHeadInfoVO{" + "shopId=" + shopId + ", type=" + type + ", ownerUserId=" + ownerUserId
				+ ", shopName='" + shopName + '\'' + ", intro='" + intro + '\'' + ", noticeMobile='" + noticeMobile
				+ '\'' + ", shopLogo='" + shopLogo + '\'' + ", isPreferred=" + isPreferred + ", shopStatus="
				+ shopStatus + ", mobileBackgroundPic='" + mobileBackgroundPic + '\'' + ", pcBackgroundPic='"
				+ pcBackgroundPic + '\'' + '}';
	}
