...
public interface SpuMapper extends BaseMapper<Spu> {
	...
	List<Long> getSpuIdsBySpuUpdateDTO(@Param("shopCategoryIds") List<Long> shopCategoryIds,
			@Param("categoryIds") List<Long> categoryIds, @Param("brandId") Long brandId, @Param("shopId") Long shopId);
	 ...
	 * @return 商品列表
	 */
	List<SpuVO> pageByLangAndTagId(@Param("pageDTO") PageDTO pageDTO, @Param("spuDTO") SpuDTO spuDTO,
			@Param("isContain") Integer isContain);
