...
public interface AuthAccountMapper extends BaseMapper<AuthAccount> {
	 ...
	 */
	void updatePassword(@Param("userId") Long userId, @Param("sysType") Integer sysType,
	 ...
	 * @return uid
	 */
	AuthAccount getAccountByInputUserName(@Param("validAccount") String validAccount,
	 ...
	 * @return
	 */
	int updateUserInfoByUserId(@Param("authAccount") AuthAccount authAccount, @Param("userId") Long userId,
